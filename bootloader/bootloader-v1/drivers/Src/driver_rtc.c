...
#define TIME_FORMAT_AM              0x00000000U
...
void rtc_tamper_detect_init(void)
{
	...
	/*Configure RTC Tamper EXTI Interrupt*/
...
void rtc_timestamp_init(void)
{
	...
	/*Configure RTC timestamp EXTI Interrupt*/
	EXTI->IMR |= (1U<<21);
...
void rtc_alarm_init(void)
{
	...
	/*Configure RTC Alarm Interrupt : See page207 of ref. manual*/
	EXTI->IMR |= (1U<<17);
	...
	/*Enable Alarm Interrupt in NVIC*/
	interrupt_config(RTC_Alarm_IRQn, ENABLE);
