...
#define DMA2_Stream0_BASEADDR     (DMA2_BASEADDR + 0x010U)
#define DMA2_Stream1_BASEADDR     (DMA2_BASEADDR + 0x028U)
#define DMA2_Stream2_BASEADDR     (DMA2_BASEADDR + 0x040U)
#define DMA2_Stream3_BASEADDR     (DMA2_BASEADDR + 0x058U)
#define DMA2_Stream4_BASEADDR     (DMA2_BASEADDR + 0x070U)
#define DMA2_Stream5_BASEADDR     (DMA2_BASEADDR + 0x088U)
#define DMA2_Stream6_BASEADDR     (DMA2_BASEADDR + 0x0A0U)
#define DMA2_Stream7_BASEADDR     (DMA2_BASEADDR + 0x0B8U)
