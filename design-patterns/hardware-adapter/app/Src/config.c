...
static const GPIO_Config_t gpioConfigs[] = {
    ...
    {GPIOC, GPIO_PIN_NO_13, GPIO_MODE_IN,    GPIO_SPEED_FAST,    GPIO_OP_TYPE_PP, GPIO_PIN_NO_PUPD, GPIO_PIN_NO_ALTFN},
    {GPIOB, GPIO_PIN_NO_1,  GPIO_MODE_ANALOG,GPIO_SPEED_FAST,    GPIO_OP_TYPE_PP, GPIO_PIN_NO_PUPD, GPIO_PIN_NO_ALTFN}
